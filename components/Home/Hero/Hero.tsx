        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-10 items-center">
          ...
          >
            ...
            >
              ...
              {/* Download Resume - Mobile Only */}
              <motion.a
                {...buttonAnimation}
                href="/assets/resume/Shiva_Kumar_Godha_Resume.pdf"
                download
                className="md:hidden flex items-center justify-center gap-2 rounded-xl border border-indigo-200 bg-indigo-50 px-7 py-3 font-semibold text-indigo-700 transition-all duration-300 hover:scale-[1.03] hover:bg-indigo-100"
              >
